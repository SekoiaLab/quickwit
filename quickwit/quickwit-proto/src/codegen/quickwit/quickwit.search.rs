...
#[derive(
    serde::Serialize, serde::Deserialize, utoipa::ToSchema, Clone, PartialEq, ::prost::Message,
)]
...
pub struct ListFieldsEntryResponse {
    ...
    pub non_searchable_index_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    /// The index ids the field exists, but is not aggregatable
    #[prost(string, repeated, tag = "7")]
    pub non_aggregatable_index_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[derive(
    serde::Serialize, serde::Deserialize, utoipa::ToSchema, Clone, PartialEq, ::prost::Message,
)]
...
pub struct SplitIdAndFooterOffsets {
    ...
    #[prost(string, tag = "1")]
    pub split_id: ::prost::alloc::string::String,
    /// The offset of the start of footer in the split bundle. The footer contains the file bundle
    /// metadata and the hotcache.
    #[prost(uint64, tag = "2")]
    pub split_footer_start: u64,
    /// The offset of the end of the footer in split bundle. The footer contains the file bundle
    /// metadata and the hotcache.
    #[prost(uint64, tag = "3")]
...
/// * since tantivy has no notion of cardinality, all fields are arrays.
/// * since tantivy has no notion of object, the object is flattened by concatenating the path to
///   the root.
///
...
pub struct LeafSearchResponse {
    ...
    pub intermediate_aggregation_result: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
...
pub mod search_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn root_search(
            ...
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/RootSearch");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "RootSearch",
            ));
        ...
        ) -> std::result::Result<tonic::Response<super::LeafSearchResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/LeafSearch");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "LeafSearch",
        ...
        ) -> std::result::Result<tonic::Response<super::FetchDocsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/FetchDocs");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "FetchDocs",
        ...
        ) -> std::result::Result<tonic::Response<super::ListTermsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
        ...
        ) -> std::result::Result<tonic::Response<super::LeafListTermsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        pub async fn scroll(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/Scroll");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn put_kv(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/PutKV");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn get_kv(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/GetKV");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        ) -> std::result::Result<tonic::Response<super::ReportSplitsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/ReportSplits");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "ReportSplits",
        ...
        ) -> std::result::Result<tonic::Response<super::ListFieldsResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/ListFields");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "ListFields",
        ...
        pub async fn search_plan(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchRequest>,
        ) -> std::result::Result<tonic::Response<super::SearchPlanResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/quickwit.search.SearchService/SearchPlan");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "quickwit.search.SearchService",
                "SearchPlan",
...
pub mod search_service_server {
    ...
    pub trait SearchService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_fetch_docs(
            &self,
            request: tonic::Request<super::FetchDocsRequest>,
        ) -> std::result::Result<tonic::Response<Self::StreamFetchDocsStream>, tonic::Status>;
        /// Root list terms API.
        /// This RPC identifies the set of splits on which the query should run on,
        /// and dispatches the several calls to `LeafListTerms`.
        ///
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/quickwit.search.SearchService/StreamFetchDocs" => {
                        ...
                        for StreamFetchDocsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SearchService>::stream_fetch_docs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/quickwit.search.SearchService/Scroll" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::ScrollRequest> for ScrollSvc<T> {
                        type Response = super::SearchResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as SearchService>::scroll(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/quickwit.search.SearchService/PutKV" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::PutKvRequest> for PutKVSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as SearchService>::put_kv(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/quickwit.search.SearchService/GetKV" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::GetKvRequest> for GetKVSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as SearchService>::get_kv(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/quickwit.search.SearchService/ReportSplits" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::ReportSplitsRequest>
                ...
                "/quickwit.search.SearchService/ListFields" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::ListFieldsRequest> for ListFieldsSvc<T> {
                ...
                "/quickwit.search.SearchService/LeafListFields" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::LeafListFieldsRequest>
                        for LeafListFieldsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SearchService>::leaf_list_fields(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/quickwit.search.SearchService/SearchPlan" => {
                    ...
                    impl<T: SearchService> tonic::server::UnaryService<super::SearchRequest> for SearchPlanSvc<T> {
