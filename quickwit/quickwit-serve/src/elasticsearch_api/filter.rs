...
-> impl Filter<Extract = (Vec<String>, SearchQueryParams, SearchBody, Option<String>), Error = Rejection>
+ Clone {
...
-> impl Filter<Extract = (Bytes, MultiSearchQueryParams, Option<String>), Error = Rejection> + Clone
{
